...
class AccountController extends Controller
{
    ...
    public function scanAccount(Request $request)
    {
        ...
        if($client->business_id != Auth::user()->business_id) {
            return response()->json(['error' => 'This account is not associated with this business'], 400);
        }
    ...
    private function getAccountInfo($account){
        ...
        try {
            ...
            return response()->json([
                ...
                'name' => $acc->client->first_name .' '.
                        ($acc->client->middle_name !== null ? $acc->client->middle_name.' ' : '') .
                        $acc->client->last_name .' '.
                        ($acc->client->extension_name ? $acc->client->extension_name : ''),
